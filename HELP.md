...
* The original package name 'br.com.marcoshssilva.spring-admin-server' is invalid and this project uses 'br.com.marcoshssilva.springadminserver' instead.
...
```
$ docker run --rm -p 8080:8080 spring-admin-server:0.0.1-SNAPSHOT
```
